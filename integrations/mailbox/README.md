...
- 邮箱池默认按显示名称升序排列，支持名称升/降序、最近查询、已出码优先、最久未续期、按来源筛选，以及“仅未接入 Codex”和“仅显示未注册 GPT”筛选；前者依据当前 Manager 已接入账号目录判断，后者依据邮箱池中的 GPT 注册标记判断。Mailbox 宽页面固定为上方邮箱卡片列表、下方当前邮箱详情；每个邮箱显示上次成功续期时间，没有成功续期记录时显示添加时间。
