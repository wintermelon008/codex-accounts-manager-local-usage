...
| 类别       | 功能                                                                                                           | 需要做什么                                                                                                                                                |
| ---------- | -------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 直接可用   | 多账号 OAuth/导入、配额卡片、单账号导入凭据复制、手动启动额度倒计时、切换、详情、备份/恢复、状态栏、跨窗口同步 | 安装后导入账号即可使用；真实 Codex 账号可从卡片直接复制 Manager 可识别的导入 JSON；只要任一有效 5h/长期主额度窗口尚未启动，倒计时启动按钮就会显示。                 |
